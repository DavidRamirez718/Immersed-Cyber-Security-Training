...
let getAccessLogs = (pageIndex, pageSize) => {
  ...
  let getAccessLogsByEntityOrAccess = (pageIndex, pageSize, entityTypeId, accessStatusId) => {
    const config = {
      method: "GET",
...
const accessLogsService = {getAccessLogs, getAccessLogsByDate, searchAccessLogs, getAccessLogsByEntityOrAccess};
